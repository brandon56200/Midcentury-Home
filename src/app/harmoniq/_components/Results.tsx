    ...
    <div className="flex-1 flex flex-col bg-transparent selection:bg-blue-600/10">
      <div className="pb-32 space-y-0">
        ...
        <ProfessionalArticleSection
          ...
          title="The Death of the Modality Tax"
        ...
        <ProfessionalArticleSection
          ...
          title="Cognitive and Perceptual Frontiers"
        ...
        <ProfessionalArticleSection
          number="04"
          subtitle="Technical Gaps"
          title="The Bridge to Native Intelligence"
        ...
        <ProfessionalArticleSection
          number="05"
          subtitle="Modular Benchmarking"
          title="STS vs. Specialized Layers"
